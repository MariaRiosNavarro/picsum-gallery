...
// ! ---------Function with .then.then.catch Version comented---under that--MODERN ASYNC VERSION
...
// # ========= MODERN VERSION WITH ASYNC ARROW FUNCTION & Try/catch:
...
const fetchAndRender = async (page) => {
  try {
    ...
    // add cleanup code here (if needed it).
  }
};
